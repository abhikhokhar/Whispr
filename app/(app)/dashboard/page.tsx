...
const Dashboard = () => {
  ...
  const fetchStatus = useCallback(async () => {
    ...
    try {
      ...
      toast.error('Could not fetch message status')
    } finally {
  ...
  }, [session, fetchStatus, fetchMessages])

  // Toggle accepting messages
  const handleToggle = async () => {
    setToggleLoading(true)
    const newVal = !isAccepting
    setIsAccepting(newVal) // optimistic
    try {
      ...
      console.log('Toggle response:', newVal, res.data)
    } catch (error) {
      setIsAccepting(!newVal) // rollback
      ...
      <>
        ...
        <div className="whispr-root">
          ...
          <div className="page-loader">
            <svg viewBox="0 0 72 72" fill="none" width="48" height="48" style={{marginBottom:16}}>
              <rect x="10" y="14" width="52" height="36" rx="12" fill="url(#lg-loader)" opacity="0.95"/>
              <polygon points="22,50 14,60 30,50" fill="url(#lg-loader)" opacity="0.95"/>
              <defs>
                <linearGradient id="lg-loader" x1="10" y1="14" x2="62" y2="50" gradientUnits="userSpaceOnUse">
      ...
      <div className="whispr-root">
        ...
        <main className="main-content">
          ...
          <div className="hero-row">
            ...
            <div className="stats-row">
              ...
              <div className="stat-card accent">
                <span className="stat-num">{isAccepting ? 'ON' : 'OFF'}</span>
                <span className="stat-label">Accepting</span>
              </div>
            </div>
          </div>
          ...
          <div className="control-row">
            ...
            <div className="glass-card share-card">
              ...
              <div className="link-row">
                <div className="link-box">
                  <span className="link-text">{profileUrl}</span>
                </div>
            ...
            {/* Toggle card */}
            <div className="glass-card toggle-card">
              <div className="card-header">
                <div className="card-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} width={16} height={16}>
              ...
              <div className="toggle-row">
                ...
                <button
                  className={`premium-toggle ${isAccepting ? 'active' : ''} ${toggleLoading ? 'loading' : ''}`}
                  onClick={handleToggle}
                  disabled={toggleLoading || fetchingStatus}
                  aria-label="Toggle message acceptance"
                >
                  <span className="toggle-track">
                    <span className="toggle-thumb">
                      {toggleLoading && <span className="thumb-spinner" />}
                    </span>
          ...
          <div className="messages-section">
            ...
            {fetchingMessages ? (
              ...
              <div className="empty-state">
                ...
                <button className="empty-copy-btn" onClick={handleCopy}>
                  Copy your link →
                </button>
              </div>
            ) : (
...
const globalStyles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .premium-toggle.active .toggle-track {
    background: linear-gradient(135deg, rgba(99,102,241,0.4), rgba(139,92,246,0.4));
    border-color: rgba(99,102,241,0.5);
    box-shadow: 0 0 20px rgba(99,102,241,0.25), 0 0 0 1px rgba(99,102,241,0.15);
  }
  ...
  .premium-toggle.active .thumb-spinner {
